...
const {data: actividadesEconomicasCnae, execute} = useAsyncData(async()=>{
  return await $api.actividadEconomicaCNAE.obtenerActividadesEconomicas()
})
...
.grid.items-start.w-full.bg-white.p-4.rounded-md(class="h-[600px]")
    ...
    hr.mt-2
    .grid.items-center.p-2(v-if="actividadesEconomicasCnae?.length")
        ClasificacionesAEPCNAEActividadEconPrincCNAETable(:actividades-cnae="actividadesEconomicasCnae")
        ClasificacionesAEPCNAEActividadEconPrincCNAEDrawer(
